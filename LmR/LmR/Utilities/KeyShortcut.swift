...
enum KeyShortcut {
    ...
    struct Definition {
        ...
        static let palette = Definition(
            enabledKey: AppStorageKey.paletteHotKeyEnabled.rawValue,
            keyCodeKey: AppStorageKey.paletteHotKeyKeyCode.rawValue,
            modifiersKey: AppStorageKey.paletteHotKeyModifiers.rawValue,
            displayKey: AppStorageKey.paletteHotKeyDisplay.rawValue,
            defaultEnabled: true,
...
extension Notification.Name {
    static let openCommandPalette = Notification.Name("LmR.openCommandPalette")
}
